...
;; Projects
;;
(if (file-exists-p "~/Development/kitanda/dogen/git/CMakeLists.txt")
...
(if (file-exists-p "~/code/kitanda/git/CMakeLists.txt")
...
(if (file-exists-p "~/code/cmake_git/CMakeLists.txt")
...
(if (file-exists-p "~/code/kitanda/modeling/CMakeLists.txt")
