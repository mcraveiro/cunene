...
/**
 * to set this file as your .psqlrc, symlink it (assuming there is no
 * existing .psqlrc):
 *
 * ln -s ${KITANDA_LOCATION}/sql/psqlrc.sql ~/.psqlrc
 *
 * where ${KITANDA_LOCATION} is the full path to this file.
 */
