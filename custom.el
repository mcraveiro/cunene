(custom-set-variables
 ...
 '(package-selected-packages
   '(company-box company-posframe company git-messenger deadgrep lsp-treemacs lsp-ui lsp-mode color-identifiers-mode git-timemachine string-inflection smart-hungry-delete smartparens rainbow-delimiters marginalia consult-dir dashboard drag-stuff consult-flycheck consult highline vertico-quick eshell-git-prompt doom-themes use-package))
