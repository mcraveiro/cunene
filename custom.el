(custom-set-variables
 ...
 '(package-selected-packages
   '(smart-hungry-delete smartparens rainbow-delimiters marginalia consult-dir dashboard drag-stuff consult-flycheck consult highline vertico-quick eshell-git-prompt doom-themes use-package))
